...
export default function IgniteItForm() {
  ...
  return (
    <>
      <div className="mx-[50px] w-[100%] flex-col bg-white/10 rounded-3xl
      flex justify-center py-10 px-6 text-white">
        <div className="flex justify-between items-center mb-6">
          <div className="relative h-10 min-w-75">
            <h1
          ...
          <Switch.Group>
            <div className="flex items-center gap-2">
              <Switch.Label>Developer Mode</Switch.Label>
              <Switch
                checked={isDevMode}
    ...
    focus:outline-none " />
          ...
          <div>
            ...
            <input type="text" className="w-full bg-black/30 p-2 flex items-center gap-2  
ring-1 ring-white/10 mt-2 rounded-md px-3 py-2 transition-all duration-400 focus-within:ring-2 
focus-within:ring-[#123727] focus-within:shadow-[0_0_5px_#00ff88,0_0_8px_#00ff88]
focus:outline-none " />
          </div>
          ...
          <div>
            <label className="block mb-1">
              {isDevMode ? "Description " : "Full Description"}
            </label>
            <textarea className=" min-h-[120px]  w-full bg-black/30 p-2  flex items-center gap-2  
    ring-1 ring-white/10 mt-2 rounded-md px-3 py-2
    transition-all duration-400 focus-within:ring-2 
    focus-within:ring-[#123727] focus-within:shadow-[0_0_5px_#00ff88,0_0_8px_#00ff88]
    focus:outline-none
...
w-full bg-black/30 
    ...
    focus:outline-none              " />
              ...
              <button
                type="submit"
                className="
w-full py-3 bg-[#144D35] backdrop-blur-2xl 
                z-10 relative text-white 
                transition duration-300 hover:-translate-y-1 hover:shadow-lg 
                hover:shadow-[#144D35]/30 transform px-6 rounded-lg font-semibold              "
              >
                Add My Project
              </button>
            </>
            ...
            <>
              ...
              <div>
                ...
                <input type="text" placeholder="e.g. productivity, health" className="
w-full bg-black/30 
    p-2 
    flex items-center gap-2  
    ring-1 ring-white/10 mt-2 rounded-md px-3 py-2
...
w-full bg-black/30 
    ...
    focus:outline-none              " />
              ...
              <div>
                ...
                <input type="number" min={0} placeholder="$" className="
w-full bg-black/30 
    p-2 
    flex items-center gap-2  
    ring-1 ring-white/10 mt-2 rounded-md px-3 py-2
    ...
    focus:outline-none              " />
              ...
              <button
                type="submit"
                className="w-full py-3 bg-[#144D35] backdrop-blur-2xl 
                z-10 relative text-white 
                transition duration-300 hover:-translate-y-1 hover:shadow-lg 
                hover:shadow-[#144D35]/30 transform px-6 rounded-lg font-semibold"
              >
