  ...
  return (
    ...
    >
      ...
      <div className="  flex-1 relative md:left-[-45px] ">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-[#0e0d0dad] ring-1 ring-white/10 p-4 rounded-md flex items-center justify-between">
            ...
            <div className="text-white py-3 w-[50px] h-[50px] px-1 cursor-pointer rounded-lg bg-[#1f1c1cad] ring-2 ring-white/10 flex justify-center items-center">
              <ArrowRight className="cursor-pointer transition-all duration-700 hover:rotate-[-45deg] hover:opacity-100" />
            </div>
          </div>
          ...
          <div className="bg-[#0e0d0dad] ring-1 ring-white/10  p-4 rounded-md flex items-center justify-between">
            ...
            <div className="text-white py-3 w-[50px] h-[50px] px-1 rounded-lg bg-[#1f1c1cad] ring-2 ring-white/10 flex justify-center items-center   cursor-pointer">
              <ArrowRight className="transition-all duration-700 hover:rotate-[-45deg] hover:opacity-100" />
            </div>
          </div>
      ...
      <form
        ...
        className="flex-1 space-y-4  pt-6  relative md:right-[-45px] bg-[#0D0D0D]  px-4 ring-1 ring-white/10 rounded-2xl"
      >
        <div className="flex gap-4 ">
          <div className="w-full">
            <input
              ...
              className="rounded-md ring-1 ring-white/10 focus:outline-none focus:ring-2 focus:ring-[#123727] focus:shadow-[0_0_5px_#00ff88,0_0_8px_#00ff88] transition-all duration-400 w-full p-3 bg-[#141414] text-white placeholder-gray-400 py-5"
            />
        ...
        <input
          ...
          className="rounded-md ring-1 ring-white/10 focus:outline-none focus:ring-2 focus:ring-[#123727] focus:shadow-[0_0_5px_#00ff88,0_0_8px_#00ff88] transition-all duration-400 mt-2 w-full p-3 bg-[#141414] text-white placeholder-gray-400 py-5"
        />
        ...
        <div className="relative">
          <button
            type="submit"
            className="w-full bg-[#0a3a23] font-semibold py-4 backdrop-blur-2xl z-10 relative text-white px-6 rounded-lg transition duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-[#144D35]/30 transform"
          >
            Get started
          </button>
